"""
This file contains the MDPIKnowledgeBase class, which performs semantic search
through the all MDPI journals API.
"""
...
class MDPIKnowledgeBase(LocalSearchAPI):
